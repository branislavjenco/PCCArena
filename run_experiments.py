...
def main():
    ...
    for rate in range(1):
        ...
        draco.run_dataset('blensor', 'experiments')
        #draco.run_dataset('blensor_no_noise', 'experiments')
        #draco.run_dataset('CAPOD', 'experiments')
    ...
    #for rate in range(8):
        ...
        #gpcc.run_dataset('blensor', 'experiments')
        #gpcc.run_dataset('blensor_no_noise', 'experiments')
        #gpcc.run_dataset('CAPOD', 'experiments')
    ...
    #for rate in range(4,5):
        ...
        #pcgc_v1.run_dataset('blensor', 'experiments')
        #pcgc_v1.run_dataset('blensor_no_noise', 'experiments')
        #pcgc_v1.run_dataset('CAPOD', 'experiments')
    ...
    #for rate in range(7):
        ...
        #pcgc_v2.run_dataset('s3dis', 'experiments')
        #pcgc_v2.run_dataset('blensor_no_noise', 'experiments')
        #pcgc_v2.run_dataset('blensor', 'experiments')
        #pcgc_v2.run_dataset('CAPOD', 'experiments')
    ...
    #for rate in range(4):
        ...
        #geocnn_v2.run_dataset('blensor', 'experiments')
        #geocnn_v2.run_dataset('blensor_no_noise', 'experiments')
        #geocnn_v2.run_dataset('CAPOD', 'experiments')
